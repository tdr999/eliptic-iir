...
class MiBand(device: BluetoothDevice) {
    ...
    val gattCallback = object : BluetoothGattCallback() { //public callback so we get our variables
        ...
        override fun onServicesDiscovered(gatt: BluetoothGatt,
            ...
            val caracteristicaAuth = serviciuDeConectare.getCharacteristic(UUID.fromString("00000009-0000-3512-2118-0009af100700"))
            val descAuth = caracteristicaAuth.getDescriptor(UUID.fromString("00002902-0000-1000-8000-00805f9b34fb"))
    ...
    fun getSteps() {
        ...
        val descAuth = steps_characteristic?.getDescriptor(UUID.fromString("00002902-0000-1000-8000-00805f9b34fb"))
